...
/**
 * Iced wrapper object for primitive types and arrays, to allow fields in other
 * Iced classes to have a generic type equivalent to Object, which can contain
 * primitives, arrays, and Iced objects.
 */
public class IcedWrapper extends Iced {
	...
	/**
	 * Class of the wrapped type (could be a class of a primitive type like
	 * Integer.TYPE).
	 */
	String t = null;
