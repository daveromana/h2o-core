 ...
 * {@link NonBlockingHashMap} scales substatially better than
 ...
 * 
 * @author Prashant Deva Modified from original NonBlockingHashMap to use
 *         identity equality. Uses System.identityHashCode() to calculate
 *         hashMap. Key equality is compared using '=='.
 */

public class NonBlockingIdentityHashMap<TypeK, TypeV> extends AbstractMap<TypeK, TypeV>
	...
	private static final Object get_impl(final NonBlockingIdentityHashMap topmap, final Object[] kvs,
			final Object key) {
	...
	private static final Object putIfMatch(final NonBlockingIdentityHashMap topmap, final Object[] kvs,
	...
	private static final class CHM<TypeK, TypeV> {
		...
		private final Object[] resize(NonBlockingIdentityHashMap topmap, Object[] kvs) {
			...
			if (CAS_newkvs(newkvs)) { // NOW a resize-is-in-progress!
				...
				// System.out.println(" "+nano+" Resize from "+oldlen+" to "+(1<<log2)+" and had
				// "+(_resizers-1)+" extras" );
		...
		// read it yet.
		private final Object[] copy_slot_and_check(NonBlockingIdentityHashMap topmap, Object[] oldkvs, int idx,
				Object should_help) {
			assert chm(oldkvs) == this;
			Object[] newkvs = _newkvs; // VOLATILE READ
	 ...
	 * {@link NonBlockingIdentityHashMap} does not normally create or using
