...
public class AstStrSplit extends AstPrimitive {
	...
	public ValFrame apply(Env env, Env.StackHelp stk, AstRoot asts[]) {
		...
		for (Vec v : fr.vecs())
			if (!(v.isCategorical() || v.isString())) {
				throw new IllegalArgumentException("strsplit() requires a string or categorical column. " + "Received "
	...
	/**
	 * Run through column to figure out the maximum split that any string in the
	 * column will need.
	 */
